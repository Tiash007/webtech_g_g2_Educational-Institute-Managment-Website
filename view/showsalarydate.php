        ...
        <form action="" method="">
            ...
            <table align="center" border="1" style="border-collapse: collapse;" width="35%">
                ...
                <tr>
                    ...
                    <td align="center" colspan=3> <h2>Show SalaryDate</h2> </td>
                ...
                <tr height="40px">
                    ...
                    <td style="padding-left: 5px;"> 
                        <?php 
                        $myfile = fopen("../php/sdate.txt", "r") or die("Unable to open file!");
